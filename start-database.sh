...
DB_CONTAINER_NAME="pastport-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=pastport -d -p 5432:5432 docker.io/postgres
