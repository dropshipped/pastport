...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="relative flex h-[40rem] items-center justify-center p-8 sm:p-20 md:h-[60rem]"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className=" mx-auto -mt-12 h-[30rem] w-full max-w-xl rounded-[30px] border-4 border-[#6C6C6C] bg-[#222222] p-6 md:h-[40rem]"
    >
      <div className="h-full w-full gap-4 overflow-hidden rounded-2xl">
        ...
        >
          {/* <div className="absolute right-2 top-2 rounded-full bg-white px-2 py-1 text-xs font-bold"></div> */}
          <img
            src="/assets/screenshot.jpg"
            className="h-full w-full object-contain object-top text-sm"
            alt="thumbnail"
          />
          {/* <div className="p-4">
